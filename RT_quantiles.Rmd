...
```{r Shift lateral left baseline, fig.height=6}
...
```{r Shift lateral left tDCS, fig.height=6}
...
```{r Shift lateral left post-1, fig.height=6}
...
```{r Shift lateral left post-2, fig.height=6}
