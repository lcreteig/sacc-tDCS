...
sessionFolder = fullfile(rootFolder,'data','S18','session_K_orig');
load(fullfile(sessionFolder,'post','sacc-tDCS_S18_K_main.mat'));
...
data = dataAll;
save(fullfile(rootFolder,'data', 'S18','sacc-tDCS_S18_K_main.mat'),'timeStamps','data','xp');
