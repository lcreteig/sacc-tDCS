...
`fef_rois.sh` takes the MNI coordinates and adds spherical masks, centered around each subjects FEF coordinate, to the MNI template. The masks for each subject have different intensities, to be able to distinguish them easily in overlays.
...
bash src/func/fef_rois.sh $exclMNI neuronav/FEF_ROIs.nii.gz 2
```