...
This clearly shows that all the changes are quite tiny (less than 0.15 degrees of visual angle). There appears to be a clear difference in  between the anodal and cathodal change scores for center saccades (and maybe for left-lateral saccades). However, the earlier plots show what the difference between anodal and cathodal is actually maximal in the baseline. Thus it remains unclear whether the baseline differences are spurious and the effect is real, or whether the effect is driven by the baseline difference.
